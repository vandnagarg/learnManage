        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, db_1.Course.findAll()];
                case 1:
                    courses = _b.sent();
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, db_1.Course.findAll({
                        where: {
                            id: (_a = {},
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, db_1.Course.findOne({
                            where: {
                                id: id,
                            }
                        })];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, db_1.Course.destroy({
                            where: {
                                id: (_a = {},
                                    _a[sequelize_1.Sequelize.Op.eq] = id,
                                    _a),
